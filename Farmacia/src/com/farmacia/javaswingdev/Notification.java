package com.farmacia.javaswingdev;
...
public class Notification extends javax.swing.JComponent {
    ...
    private void init(String message) {
        ...
        if (type == Type.SUCCESS) {
            ...
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/farmacia/javaswingdev/info.png")));
            lbMessage.setText("Info");
        } else {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/farmacia/javaswingdev/warning.png")));
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/farmacia/javaswingdev/sucess.png"))); // NOI18N
